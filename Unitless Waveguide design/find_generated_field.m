function E_out = find_generated_field(y,z,waveguide,k,Lambda,eta,I_0,k_y,I_norm,N,y_0,z_0)
    % calc the elctric field created by the currents runnig throw the
    ...
    E_out = pi^2/Lambda*trapz(k_y,sum(sumTensor,[2,3]),1);
end