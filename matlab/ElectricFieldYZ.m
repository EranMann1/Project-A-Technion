function [TotalElectricFieldMatrix, GeneratedElectricFieldMatrix] = ElectricFieldYZ(Is,Ds,Hs,k,Lambda,y,z,theta_in,Ein,N,eta)
...
%     Is = zeros(length(Zs),1);
%     for index = 1:length(Zs)
%         Is(index) = EIsYz2(Ds(index),Hs(index))/Zs(index);
%     end
